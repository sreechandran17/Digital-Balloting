...
<	</ul>
	...
	<div id = "frm" class="input-icons">  
        ...
        <form name="f1" action = "db_authentication.php" onsubmit="return validation()" method = "POST" >  
            <p>  
				<center><i class="fa fa-user icon"></i><input class="input-field" type="text" style="font-size: 12pt; height: 40px; width:280px;border-radius: 18px;text-align: center;" id="voterid" name="voterid" placeholder="Voter ID" style="height:30px;font-family:georgia;align:left;"><span class="asterisk_input"></span><br></center><br><br>
				...
				<center><p><b>Not Yet a member?</b><input type = "submit" name= "registration" id = "btn2" value = "Sign Up" ></center>
            </p>  
        </form>  
    </div>   
    <script>  
